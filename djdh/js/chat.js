    ...
    2: [function(M, t, e) {
        ...
        ! function() {
                                    ...
                                    s = r.id, c = r.name,
                                        ...
                                        function t(e) {
                                            ...
                                            e.forEach(function(t, e) {
                                                var n = i('<a class="ctrm-domain-item" target="_blank" rel="noopener" href="http://' + t.domainFrom + '">' + t.domainFrom + "</a>");
                                                k.append(n)
                                            });
                                            if (!u && 3 < l.length) {
            ...
            function H(t) {
                ...
                b.append(n), I(),
                    function() {
                        ...
                        g.addClass("glow"), setTimeout(function() { g.removeClass("glow") }, 300)
            ...
            function R() {
                ...
                if (0 === t.length) return alert("消息不能为空");
                if (!r) {
