document.writeln("<aside class=left-bar id=leftBar><div class=title><a href=# rel=noopener title=关于本站 onclick=\'document.getElementById(\'dome\').innerHTML=obj.sites[0].hello\'><i class=jiaran></i></a><!-- h1是方便搜索引擎,设置隐藏` --><h1 style=display:none>夏dj导航站</h1><a  target=_blank rel=noopener href=\'https://cn.bing.com/search?q=%E5%A4%8Fdj%E5%AF%BC\'>夏DJ导航站</a></div><nav class=nav><div class=\'item active\'><i class=\'iconfont icon-shoucangbenzhan\'></i> <a href=javascript:; onclick=addFavorite(this)>点我收藏本站</a> <i class=line></i></div><ul class=nav-item id=navItem>");
document.writeln("<li><a href=index.html#nice class=active><i class=\'iconfont icon-like-fill\'></i>置顶网站</a></li>");
...
document.writeln("<li><a href=index.html#designrace><i class=\'iconfont icon-bisai\'></i>设计比赛</a></li>");
document.writeln("<li><a href=index.html#soutu><i class=\'iconfont icon-soutu\'></i>在线搜图</a></li>");
...
document.writeln("</ul>");
document.writeln("<div class=\'item comment\'><a target=_blank rel=noopener href='https://zl88.github.io/posts/56198.html'><i class=\'iconfont icon-gengxinrizhi\'></i>更新日志</a></div>");
